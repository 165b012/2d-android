...
public class player : MonoBehaviour {
	...
	//ジャンプキャンセル
	public const float JUMP_CANSEL_TIME = 0.5f;
	//有効
	...
	void Update(){
		...
		if (!gameClear) {
			//スペースキーを押し、
			if ((Time.time >= jumpIgnoreTime) && (Input.GetKeyDown ("space") || CrossPlatformInputManager.GetButtonDown ("Jump"))) {
